---
layout: nube-post
title: "Código en Markdown de Obsidian"
category: recursos
date: 2026-03-31
description: "Markdown será tu amigo de ahora en adelante"
---

# ¿Cómo poner código en [[Markdown]]?

- Se debe usar comilla hacia atrás {AltGr + llaves}

```
print("Hola, este es un código dentro de Markdown de Obsidian)

```

Tambien puedes ser virgulillas !~~~
...
Para dar color al código, se debe poner la extensión del lenguaje en que se escribe, por ejemplo:

```bash
sudo chmod u+x data.sh
git add .
git commit -m "Este código pinta muy bien"
...
### #Obsidian usa #prisma para dar formato al lenguaje. y los que soporta son:
